...
//!
//! https://github.com/nicopap/bevy-scene-hook/blob/main/src/hook.rs
...
pub fn run_hooks(
    ...
    for (entity, instance, hooked) in unloaded_instances.iter() {
        ...
        // log::info!("Printing components for entity: {}", entity);
        // if let Ok(components) = world.inspect_entity(entity) {
